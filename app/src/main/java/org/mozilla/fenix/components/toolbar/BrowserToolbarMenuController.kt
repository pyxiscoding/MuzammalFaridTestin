...
class DefaultBrowserToolbarMenuController(
    ...
    private val tabsUseCases = activity.components.useCases.tabsUseCases
    private val downloadUseCases = activity.components.useCases.downloadUseCases
    private var controller = DefaultDeleteBrowsingDataController(
    ...
    override fun handleToolbarItemInteraction(item: ToolbarMenu.Item) {
        ...
        Do exhaustive when (item) {
            ...
            is ToolbarMenu.Item.SearchPreference -> {
                scope.launch {
                    /*
                    * log alifhasnain
                    * When search preference is click always open the given
                    * link inside luxxle browser
                    * */
                    activity.openToBrowserAndLoad(
                            searchTermOrURL = "https://luxxle.com/preferences",
                            newTab = false,
            ...
            is ToolbarMenu.Item.DeleteBrowsingData -> {
                scope.launch {
                    val context = swipeRefresh.context
                    context?.let {
    ...
    private fun trackToolbarItemInteraction(item: ToolbarMenu.Item) {
        val eventItem = when (item) {
            ...
            is ToolbarMenu.Item.DeleteBrowsingData -> Event.BrowserMenuItemTapped.Item.DELETE_BROWSING_DATA
            is ToolbarMenu.Item.SearchPreference -> Event.BrowserMenuItemTapped.Item.SEARCH_PREFERENCE
        }
    ...
    private fun deleteSelected(context: Context) {
        MainScope().launch(Dispatchers.IO) {
            withContext(Dispatchers.Main) {
                finishDeletion(context)
                metrics.track(Event.ClearedPrivateData)
    ...
    private fun finishDeletion(context: Context) {
        ...
        FenixSnackbar.make(
            ...
            .setText(
                context.getString(R.string.preferences_delete_browsing_data_snackbar)
            )
            .show()
        navController.navigate(
