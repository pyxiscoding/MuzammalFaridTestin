...
//            },
            ...
            onAddonsManagerTapped = {
                Log.d("Add-ons", "Addons clicked inside a webpage")
    ...
    override val menuToolbar by lazy {
        val back = BrowserMenuItemToolbar.TwoStateButton(
            primaryImageResource = R.drawable.ic_arrow_back,
        ...
        val forward = BrowserMenuItemToolbar.TwoStateButton(
            ...
            primaryImageResource = R.drawable.ic_arrow_forward,
...
//        )
        ...
        val openInApp = BrowserMenuHighlightableItem(
            ...
            startImageResource = R.drawable.door_open_black,
            iconTintColorResource = primaryTextColor(),
            highlight = BrowserMenuHighlight.LowPriority(
                label = context.getString(R.string.browser_menu_open_app_link),
                notificationTint = getColor(context, R.color.whats_new_notification_color)
...
//            reportSiteIssuePlaceholder,
    ...
    private val newCoreMenuItems by lazy {
        ...
        val bookmarkSiteItem = BrowserMenuImageText(
        ...
        val historyItem = BrowserMenuImageText(
            context.getString(R.string.library_history),
            R.drawable.history_update_black,
            primaryTextColor()
        ) {
            onItemTapped.invoke(ToolbarMenu.Item.History)
        }
...
//        )
        ...
        /*
        * log alifhasnain
        * Removed Add to top site & save to collection
        * */
        ...
        val searchPreference = BrowserMenuImageText(////////////////
          label = context.getString(R.string.search_preference),
            imageResource = R.drawable.ic_search_preference,
            iconTintColorResource = primaryTextColor()
        ) {
            onItemTapped.invoke(ToolbarMenu.Item.SearchPreference)
        }
        ...
        val deleteBrowsingData = BrowserMenuImageText(
            label = context.getString(R.string.preferences_delete_browsing_data),
            imageResource = R.drawable.ic_delete,
            iconTintColorResource = primaryTextColor()
        ) {
            onItemTapped.invoke(ToolbarMenu.Item.DeleteBrowsingData)
        }
