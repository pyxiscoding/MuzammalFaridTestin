...
import org.mozilla.fenix.settings.deletebrowsingdata.*
...
class HomeFragment : Fragment() {
    ...
    private fun observeSearchEngineChanges() {
        ...
        val d: Drawable = ContextCompat.getDrawable(requireContext(), R.drawable.ic_logo_home)!!
        ...
        HomeMenu(
                ...
                onItemTapped = {
                    when (it) {
                        ...
                        /*
                        * log alifhasnain removed addons listner
                        * */
                        /*HomeMenu.Item.AddonsManager -> {
                            Log.d("Add-On", "Addon clicked HomeFragment")
                            nav(
                                    R.id.homeFragment,
