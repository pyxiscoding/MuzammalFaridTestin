...
class TabTrayViewHolder(
    ...
    override fun updateSelectedTabIndicator(showAsSelected: Boolean) {
        ...
        /*
        * log alifhasnain
        * if block shows tabs recyclerview item color in selected-mode
        * else blocks shows tabs recyclerview item colors in non-selected mode
        * */
        if (showAsSelected) {
          color = R.color.tab_tray_item_selected_background_normal_theme
        } else {
          color = R.color.tab_tray_item_background_normal_theme
        }
