...
class Settings(private val appContext: Context) : PreferencesHolder {
    ...
    var shouldDeleteBrowsingDataOnQuit by booleanPreference(
            appContext.getPreferenceKey(R.string.pref_key_delete_browsing_data_on_quit), default = false)
...
/*    var shouldUseBottomToolbar by booleanPreference(
    ...
    /*
    * made default value to false so webpage doesn't get
    * covered in first launch
    * */
    var shouldUseBottomToolbar by booleanPreference(
        appContext.getPreferenceKey(R.string.pref_key_toolbar_bottom),
        // Default accessibility users to top toolbar
    ...
    // log alifhasnain use Top toolbar by default
    ...
    * */
    ...
    /*
    * log alifhasnain
    * Updating this variable disables showing
